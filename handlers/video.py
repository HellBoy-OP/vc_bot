...
@Client.on_message(command("video") & other_filters)
@errors
async def a(client, message: Message):
    ...
    try:
        ...
        for i in range(len(dur_arr)-1, -1, -1):
            ...
            secmul *= 60
        await  message.reply_video(video_file, caption=rep, parse_mode='md',quote=False, title=title, duration=dur, thumb=hell_thumb)
        await m.delete()
    except Exception as e:
        m.edit(f"❌ Error!! \n\n{e}")
    try:
